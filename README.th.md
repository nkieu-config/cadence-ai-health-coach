...
AI wellness coach สำหรับนักศึกษาและคนเริ่มทำงาน ช่วยให้เห็นรูปแบบของการกิน การนอน และการเคลื่อนไหว
แล้วเปลี่ยนสิ่งที่ค้นพบให้เป็นเป้าหมายเล็ก ๆ ที่ทำได้จริงในตารางชีวิตของตัวเอง
...
[สรุปโปรเจกต์](docs/summary/showcase-en-light.pdf) ·
...
> [!NOTE]
> **ตัวแอปใช้ภาษาไทย** README ฉบับนี้อธิบายโปรเจกต์เป็นภาษาไทย และสามารถเลือก [English](README.md)
> เพื่ออ่านเวอร์ชันภาษาอังกฤษได้
...
- **สรุปโปรเจกต์** — [ภาพรวม 9 หน้า](docs/summary/showcase-en-light.pdf) (ภาษาอังกฤษ)

บัญชี demo เป็นบัญชีสาธารณะ สามารถกรอก แก้ไข หรือลบข้อมูลได้ตามต้องการ ข้อมูล demo จะรีเฟรชทุกคืน
และตั้งใจเว้นเช็คอินของวันนี้ไว้ให้ลองกรอกเอง การคุยกับ AI จำกัด 5 ข้อความต่อวันตามโควตา Gemini ฟรี

## เกี่ยวกับโปรเจกต์

Cadence เป็น wellness coach ไม่ใช่บริการทางการแพทย์ ออกแบบมาสำหรับนักศึกษาและคนเริ่มทำงานที่มี
ตารางชีวิตเปลี่ยนแปลงตามการเรียน เดดไลน์ การเดินทาง และระดับพลังงานในแต่ละวัน
...
แบบเช็คอินใช้คำตอบแบบกดเลือกและแสดงคำถามเสริมเฉพาะเมื่อเกี่ยวข้อง จึงบันทึกได้ภายใน 3 นาที
...
- **AI coach** — เริ่มจากคำถามที่อิงข้อมูลของตัวเอง คุยต่อ และเปลี่ยนบทสนทนาให้เป็นเป้าหมายแบบมีขั้นตอน
- **เป้าหมายเล็ก ๆ** — ตั้งเป้าหมายได้ไม่เกิน 2 ข้อต่อสัปดาห์ พร้อมติดตามความคืบหน้ารายวัน
- **สรุปประจำสัปดาห์** — เปรียบเทียบสัปดาห์ล่าสุดและทบทวนสิ่งที่เปลี่ยนแปลง
...
- **Responsible AI design** — แยกการคำนวณหลักฐานออกจากการเรียบเรียงภาษา และกำหนดขอบเขตให้ AI ทำหน้าที่เป็นโค้ช ดูรายละเอียดที่ [การออกแบบ AI](docs/07-ai-design.md)
...
ทีมออกแบบ พัฒนา ทดลองใช้ภายในทีม ทดสอบ และ deploy เป็น demo ที่ใช้งานได้จริงสำหรับการ pitch
