...
**AC ข้อ 2 ผ่านแล้วจริง:** หน้าเดียวตอบโจทย์ข้อ 9 ครบ **6/6 ข้อ** — เก็บอะไร / อะไรเป็นข้อมูลสุขภาพ / แก้-ลบเองได้ / ใช้ข้อมูลยังไง / anonymize หรือไม่ / ไม่มี dashboard องค์กร
(ตอน review เจอว่าตอบแค่ 4/6 — ขาด "anonymize/aggregate หรือไม่" กับ "dashboard องค์กร" เลยเติมการ์ด "การระบุตัวตนและการรวมข้อมูล" เข้าไป)
