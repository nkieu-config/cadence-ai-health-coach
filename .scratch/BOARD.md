...
| 4 | โค้ชโยงอาการที่ผู้ใช้เอ่ย (เช่น ปวดหัว) เข้ากับ pattern ที่บันทึกไว้ ทั้งที่ระบบไม่เคยเก็บข้อมูลอาการ — ยิง 3 ครั้งเจอ 2 | ต่ำ–กลาง | 🟡 **ยังไม่แก้** — แก้ต้องแตะ `COACH_SYSTEM_PROMPT` แล้วหลักฐาน QA-01 20/20 เป็นโมฆะ · วันเวทีเลี่ยงด้วยการใช้ภาพแทนยิงสด |
