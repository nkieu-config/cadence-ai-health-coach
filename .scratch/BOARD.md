...
| qa/03 | Pitch deck + ซ้อม | A + ทุกคน | **`deck.pdf` 11 หน้าเสร็จแล้ว** (8 + สำรอง 3) สร้างจาก `deck/deck.html` ด้วย `npm run deck` — ไม่ได้ทำใน Canva แก้แล้วสั่งสร้างใหม่ได้ · เหลือ **เติมชื่อ 4 คน** + แบ่งคนพูด + ยืนยันเวลากับอาจารย์ + ซ้อม 2 รอบ 29 ก.ค. |
