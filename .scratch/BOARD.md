...
| qa/03 | Pitch deck + ซ้อม | A + ทุกคน | **`deck.pdf` 14 หน้าเสร็จแล้ว** (10 + สำรอง 4 · ชื่อทีมขึ้นปกแล้ว) สร้างจาก `deck/deck.html` ด้วย `npm run deck` — ไม่ได้ทำใน Canva แก้แล้วสั่งสร้างใหม่ได้ · เหลือ **แบ่งคนพูด** + ยืนยันเวลากับอาจารย์ + เลือกโทนเด็คตอนเทสโปรเจกเตอร์ + ซ้อม 2 รอบ 29 ก.ค. · เริ่มที่ [docs/pitch/README](../docs/pitch/README.md) |
