...
## สถานะ: เสร็จ 62 / 69 งาน (ยกเลิก 1 · เหลือ 6)
...
| infra/20 | อุดช่องโหว่โควตารีเซ็ต | A | ตาราง `chat_daily_usage` ลงแล้ว (migration 0004) · **ยังเหลือ AC 2 ข้อ** — `deleteAllData()` ไม่ล้างตัวนับ และ RLS ยังให้ผู้ใช้แก้ตัวนับเองได้ |
| ~~f4/06~~ | ~~markdown ในฟองแชท~~ | A | ✅ ปิดแล้ว 25 ก.ค. — หัวข้อ `##` เรนเดอร์เป็นบรรทัดหนา + unit test 6 ข้อจากคำตอบ Gemini จริง |
