...
`verify:db` · `test:ai` · `refresh:demo-week` ต้องมี `.env.local` ครบ · `test:ai` คือสคริปต์ที่ใช้ผลิตหลักฐาน QA-01 (safety checklist 10 เคส × 2 ประโยค — [ผลรันอยู่ที่นี่](.scratch/ai-safety-test/))
