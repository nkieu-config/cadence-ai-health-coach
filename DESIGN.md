...
>
> ⚠️ **แผงล่างของการ์ดแชทต้องเลื่อนเองได้** (`max-h-[calc(100%-4rem)] overflow-y-auto`) — flow ตั้งเป้าหมายทำให้แผงสูงกว่าการ์ดทั้งใบบนมือถือจอเตี้ย ถ้าไม่ให้เลื่อน `overflow-hidden` ของการ์ดจะตัดปุ่ม "ถัดไป" หายไปเฉย ๆ จนกดต่อไม่ได้ · เพดานเขียนเป็น `100% - 4rem` ไม่ใช่สัดส่วน — รับประกันบทสนทนา 64px และไม่ไปบีบแผงบนจอที่กว้างพอ
>
