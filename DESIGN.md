...
7. **ปุ่มกลุ่มแบบ pill ต้องจบแถวเดียวเสมอ** — รายการคงที่ให้ย่อ label จนพอดีที่ 320px (เช่นแท็บกราฟใช้ นอน/กิน/ขยับ) · รายการที่โตได้เรื่อย ๆ ให้เลื่อนแนวนอนแบบ week picker · ห้ามปล่อยตัดขึ้นบรรทัดใหม่
