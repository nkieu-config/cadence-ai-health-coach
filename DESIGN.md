...
> Theme ชื่อ **"มิ้นต์สด"** (UX-01) — พื้นขาว + เขียวมรกตสด + มิ้นต์อ่อน · เดิมยืมพาเลตต์จากเว็บการตลาดของ Cohere ซึ่งเย็นและเป็นทางการเกินกว่าเสียงของแอป
...
6. **ข้อความไทยที่มองเห็นถาวรต้อง ≥ 12px** (`text-xs` ขึ้นไป) — สระ/วรรณยุกต์ซ้อนกันที่ 10px จะติดกัน · ตัวเลขล้วนในบริบทแน่น (แกนกราฟ/ตัวนับ) ต่ำสุด 11px · **ห้าม `text-[10px]`** — มีด่าน e2e คุมแล้ว (UX-08)
7. **ปุ่มกลุ่มแบบ pill ต้องจบแถวเดียวเสมอ** — รายการคงที่ให้ย่อ label จนพอดีที่ 320px (เช่นแท็บกราฟใช้ นอน/กิน/ขยับ) · รายการที่โตได้เรื่อย ๆ ให้เลื่อนแนวนอนแบบ week picker · ห้ามปล่อยตัดขึ้นบรรทัดใหม่ (UX-08)
...
> พาเลตต์ปัจจุบันคือ **"มิ้นต์สด"** (UX-01, 20 ก.ค.) · ก่อนหน้านั้นยืมสีจากเว็บการตลาดของ Cohere — เอกสารต้นฉบับอยู่ใน git history ของไฟล์นี้
...
- พลังงานต่ำ → `outline` ไม่ใช่ `destructive`
