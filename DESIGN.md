...
# 📚 ข้างล่างนี้คือเอกสารอ้างอิง (Cohere design analysis)

> ใช้เทียบแค่ **สี / ฟอนต์ / มุมโค้ง** ซึ่งฝังลง `globals.css` ให้หมดแล้ว
> **Layout / Grid / Components ของมันเป็นของเว็บไซต์การตลาด — ไม่ใช่ของแอปเรา**
