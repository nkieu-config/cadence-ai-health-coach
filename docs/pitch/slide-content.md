...
**บนสไลด์:** (สองภาพวางข้างกัน — ต้องเตรียม screenshot 2 ใบ)

> ## คำแนะนำเดียวกัน? ไม่ใช่
> ### check-in ชุดเดิม — เปลี่ยนบริบท คำตอบเปลี่ยน
>
> | เลือก "กิน" + วันเรียนเช้า | เลือก "ขยับ" + นั่งนาน |
> |---|---|
> | [screenshot goal 1] | [screenshot goal 2] |
> | *เตรียมมื้อเช้าง่าย ๆ ไว้ล่วงหน้า* | *ลุกยืดเหยียด 5 นาทีหลังจบคาบ* |

**พูด:** "นี่คือหัวใจที่แยกเราจากแอปทั่วไป — คำแนะนำไม่ได้มาจากลิสต์สำเร็จรูป มันผูกกับตารางและข้อจำกัดที่ปาล์มเลือก เปลี่ยน input คำตอบเปลี่ยนจริง"

**หมายเหตุ:** อันนี้ demo สดสองรอบไม่ทันเวลา จึงทำเป็นภาพ · เป็นสไลด์ที่ปิดเกณฑ์ Personalization (12%) โดยตรง — **ต้องถ่าย screenshot 2 กิ่งนี้ด้วยบัญชีทดสอบตอนซ้อม อย่าใช้ปาล์ม**
...
- [x] ~~ถ่าย screenshot 2 กิ่งของ guided flow (สไลด์ 4) ด้วยบัญชีทดสอบ~~ — มีแล้วที่ `screenshots/goal-branch-eating-mobile.png` + `goal-branch-movement-mobile.png` · ⚠️ **เป็นภาพมือถือแนวตั้ง 1170×2532 วางคู่กันบนสไลด์ 16:9 จะอ่านไม่ออกจากหลังห้อง — ต้องครอปเหลือเฉพาะการ์ดเป้าหมายกล่องแรก หรือถ่ายใหม่แบบเดสก์ท็อป**
