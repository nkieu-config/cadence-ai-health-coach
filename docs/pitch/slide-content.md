# ข้อความบนสไลด์ — ต้นฉบับเนื้อหา (8 หน้า + สำรอง 3)
...
- [x] ~~ทำ 8 หน้า → `deck.pdf`~~ — **เสร็จ 26 ก.ค.** สร้างจาก [deck/deck.html](deck/deck.html) ด้วย `npm run deck` ได้ 11 หน้า 16:9 · มี `deck-light.pdf` เผื่อโปรเจกเตอร์สู้แสงไม่ไหว
...
- [x] ~~ทำสไลด์สำรอง A + B + C ท้ายเด็ค~~ — **เสร็จ 26 ก.ค.** อยู่ในเด็คเป็นหน้า 9–11 พร้อมป้ายมุมขวาบน
