...
- ⚠️ ภาพ trend มีคำว่า **"สัญลักษณ์วันพิเศษ (Disruptors)"** ซึ่งเป็นคำที่ระบบเรียก disruptor ไม่ตรงกับ tooltip ที่เรียก "ปัจจัยรบกวน" (บั๊ก #2 ใน qa-results ยังไม่แก้) — **ถ้าแก้คำเมื่อไหร่ต้องถ่ายภาพนี้ใหม่**
