# ข้อความบนสไลด์ — ต้นฉบับเนื้อหา (8 หน้า + สำรอง 4)
...
> ⚠️ **ทำไมต้องมี** — สไลด์ 5 วางแผนไว้ว่ายิงสดบนเวที · ถ้ายิงไม่ได้ (เน็ตล่ม โควตาหมด หรือคำตอบออกมาไม่สะอาด) Plan B เดิมคือ**ออกจากเด็คไปเปิดไฟล์ภาพ** ซึ่งเป็นปัญหาเดียวกับที่สำรอง A/B/C แก้ไปแล้ว · Safety + Privacy มี **20 คะแนน**ติดอยู่กับหน้านี้
...
> ตารางนี้ย้ายมาจาก [archive/deck-outline.md](archive/deck-outline.md) แล้ว **map กับเลขสไลด์ชุด 8 หน้านี้** ของเดิมผูกกับเลขสไลด์ชุด 13 หน้าที่ไม่ได้ใช้แล้ว — ติ๊กของเดิมคือติ๊กสไลด์ที่ไม่มีอยู่จริง
