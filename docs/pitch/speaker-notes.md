...
> 🔴 **เวลาในวงเล็บท้ายหัวข้อแต่ละสไลด์เป็นของชุด 8 หน้าเดิม อย่าใช้** — งบเวลาจริงของรอบบ่ายอยู่ที่ **[run sheet 8 นาทีใน demo-script.md](demo-script.md#-run-sheet-8-นาที--ถือขึ้นเวทีแผ่นนี้)** ซึ่งตัด check-in สด · reflection · หน้า privacy ออกไปรอบเช้าแล้ว
> ไฟล์นี้ยังเป็นเจ้าของ**สคริปต์ปาก**ของทุกสไลด์ตามเดิม — ใช้คู่กัน: run sheet บอกว่าพูดนานแค่ไหน ไฟล์นี้บอกว่าพูดว่าอะไร
