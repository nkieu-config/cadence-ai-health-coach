# CONTEXT.md — ภาษากลางของโปรเจกต์ Cadence
...
| **Disruptor** | เหตุการณ์ที่กระทบ routine ในวันนั้น: `deadline`, `long_meeting`, `early_class`, `online_class`, `commute`, `exam`, `none` · **คำไทยคือ "ปัจจัยรบกวน" คำเดียวเท่านั้น** ทั้ง UI, prompt และคำตอบ AI (ห้ามใช้ "วันพิเศษ" หรือ "สิ่งรบกวน" — เคยหลุดมาแล้วจนเรียก 3 ชื่อในระบบเดียว) | เป็นหัวใจของ personalization — pattern ทุกอย่างต้องเชื่อมกับ disruptor ได้ · ค่าจริงอยู่ที่ `lib/checkins/labels.ts` |
...
| **Coach** | AI conversation ที่คุยแบบไม่ตัดสิน ถามนำ และแนะนำ practical | Coach คือ wellness coach **ไม่ใช่แพทย์** — ดู guardrail ใน [docs/08-safety-privacy.md](08-safety-privacy.md) |
...
| **Dogfooding** | ทีม 4 คนใช้แอปบันทึกจริงทุกวันตั้งแต่ check-in ใช้งานได้ | เริ่มจริง 13 ก.ค. 2026 — เป็นที่มาของบั๊กและข้อจำกัดหลายข้อใน [docs/11](11-limitations-future.md) · **ห้าม dogfood ด้วยบัญชีปาล์ม** (เป็นบัญชี demo) |
