...
บัญชี demo `palm@example.com` · `npm run seed` รันซ้ำได้ (ล้างของเก่าก่อนเสมอ) · demo beat: กด 7 วันเห็นน้อย → 14/30 วันเห็นครบ = พิสูจน์สดว่าระบบไม่สรุปมั่วเมื่อข้อมูลน้อย
