...
16 ก.ค. (A) — เสร็จ · branch `feat/infra-17-checkin-desktop-rail` · ทำทั้ง `/checkin` และ `/checkin/edit/[date]` · มือถือเหมือนเดิม

**ยึด DESIGN.md:** ไม่ขยายฟอร์ม (คง 448px — แคบ = กรอกง่ายกว่า) เติม step rail แทน · เพิ่ม note รูปแบบ "form + desktop side rail" ใน DESIGN.md แล้ว · rail เป็น `aria-hidden` ไม่ interactive → ไม่ชนกฎ 44px
