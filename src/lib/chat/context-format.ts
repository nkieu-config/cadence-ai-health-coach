...
export function formatCoachContext(data: CoachContextData): string | null {
  ...
  return [
    ...
    [
      ...
      "ข้างบนคือข้อมูลทั้งหมดที่ระบบมี — ไม่มีบันทึกอาการทางกาย ความเจ็บป่วย หรือความรู้สึกของผู้ใช้เลยสักวันเดียว",
      "ถ้าผู้ใช้เอ่ยถึงอาการหรือความรู้สึกใด ๆ ในข้อความ ห้ามบอกว่ามันเกิดวันเดียวกับตัวเลขข้างบน ห้ามบอกว่าสอดคล้องหรือสัมพันธ์กัน เพราะระบบไม่รู้ว่ามันเกิดวันไหน — ให้ถามผู้ใช้แทนว่าวันนั้นเป็นอย่างไร",
    ].join("\n"),
  ].join("\n\n");
}
