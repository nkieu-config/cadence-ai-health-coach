...
const TEMPLATES: Record<PatternId, Template> = {
  "sleep-eating-skip-breakfast": {
    observation: (a, b) =>
      `วันที่นอนน้อยกว่า 6 ชม. คุณข้ามมื้อเช้า ${a} เทียบกับ ${b} ในวันที่นอนพอ`,
  ...
  "sleep-eating-sweet-drinks": {
    observation: (a, b) =>
      `วันที่นอนน้อยกว่า 6 ชม. คุณดื่มเครื่องดื่มหวาน ${a} เทียบกับ ${b} ในวันที่นอนพอ`,
    meaning: "เป็นสัญญาณที่น่าติดตาม ยังสรุปเป็นเหตุและผลไม่ได้จากข้อมูลเท่านี้",
  ...
  "movement-next-day-sleep": {
    observation: (a, b) =>
      `คืนหลังวันที่ได้ขยับ คุณให้คะแนนการนอน ${a} เทียบกับ ${b} หลังวันที่ขยับน้อย`,
    meaning: "เป็นสัญญาณที่น่าติดตาม ยังสรุปเป็นเหตุและผลไม่ได้จากข้อมูลเท่านี้",
    nextStep: "เดินสั้น ๆ 10 นาทีหลังเลิกเรียนหรือเลิกงาน",
  },
  "movement-next-day-energy": {
    observation: (a, b) =>
      `วันถัดจากวันที่ได้ขยับ คุณรู้สึกพลังงานสูง ${a} เทียบกับ ${b} หลังวันที่ขยับน้อย`,
    meaning: "เป็นสัญญาณที่น่าติดตาม ยังสรุปเป็นเหตุและผลไม่ได้จากข้อมูลเท่านี้",
    nextStep: "เดินขึ้นบันไดแทนลิฟต์ในวันที่ตารางแน่น",
  },
  "eating-energy": {
    observation: (a, b) =>
      `วันที่กินครบทุกมื้อ คุณรู้สึกพลังงานสูง ${a} เทียบกับ ${b} ในวันที่ข้ามมื้อ`,
    meaning: "เป็นสัญญาณที่น่าติดตาม ยังสรุปเป็นเหตุและผลไม่ได้จากข้อมูลเท่านี้",
